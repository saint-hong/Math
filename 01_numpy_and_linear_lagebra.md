...
- 벡터가 기본적으로 열벡터이므로, 행벡터로 표기할 때는 [!수식](https://latex.codecogs.com/gif.latex?%5Cdpi%7B100%7D%20%5Cbg_white%20%5Cfn_cm%20r_%7Bi%7D%5E%7BT%7D) 라고 쓴다. 열 벡터 r 을 전치 연산한 것.
...
- 제곱합 : 데이터를 제곱한 뒤 모두 더한 값. 분산이나 표준편차 등을 구할 때 사용. $ x^Tx$
