...
- ```내적 inner product``` : 벡터의 곱셈 <img src="https://latex.codecogs.com/gif.latex?%5Cbg_white%20%5Cfn_cm%20%5Clarge%20x%5ETy"/>
    - 조건1) 벡터의 차원이 같아야 한다.
...
- 제곱합 : 데이터를 제곱한 뒤 모두 더한 값. 분산이나 표준편차 등을 구할 때 사용. <img src="https://latex.codecogs.com/gif.latex?%5Cbg_white%20%5Cfn_cm%20%5Clarge%20x%5ETx"/>
